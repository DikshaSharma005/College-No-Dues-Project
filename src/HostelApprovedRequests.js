...
import './HostelApprovedRequests.css';

const HostelApprovedRequests = () => {
  ...
  useEffect(() => {
    if (department) {
    axios
    .get(`http://localhost:3001/api/hostel-approved-requests?department=${department}`)
      .then((response) => {
...
export default HostelApprovedRequests;
