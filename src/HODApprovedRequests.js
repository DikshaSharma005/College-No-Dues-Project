...
import './HODApprovedRequests.css';

const HODApprovedRequests = () => {
  ...
  useEffect(() => {
    axios
    .get(`http://localhost:3001/api/hod-approved-requests?department=${department}`)
      .then((response) => {
...
export default HODApprovedRequests;
