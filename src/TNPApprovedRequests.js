...
import './TNPApprovedRequests.css';

const TNPApprovedRequests = () => {
  ...
  useEffect(() => {
    if (department) {
    axios
    .get(`http://localhost:3001/api/tnp-approved-requests?department=${department}`)
      .then((response) => {
...
export default TNPApprovedRequests;
